                        ...
                        <Grid size={{ xs: 12, md: 8 }}>
                            ...
                            <Box id="section2" className="toc-content" sx={{ mb: 6, scrollMarginTop: isMobile ? 80 : HEADER_OFFSET + 20 }}>
                                ...
                                <Box className="blog-sub-content" sx={{ mb: 3 }}>
                                    ...
                                    <Typography variant="body1">
                                        In our previous blog <Link href="/blog-deepseek-vs-chatgpt">DeepSeek vs ChatGPT</Link>, we explored emerging AI challengers. Now, with Gemini 1.5 vs ChatGPT 5, the spotlight is on two global tech giants. This isn’t just about performance — it’s about how AI is shaping entire industries, from marketing and e-commerce to research and enterprise solutions
                                    </Typography>
                                </Box>
                            </Box>
